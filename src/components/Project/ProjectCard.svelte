...
<div class="project-card-container" on:mouseleave={hide_description} on:mouseenter={show_description} on:click={handle_navigation}>
    ...
    <div class="project-card-description">
        <div class="project-card-container__description" in:appear out:appear>
            <p>{`${shortDescription.substring(0, MAX_SIZE)}${shortDescription.length > MAX_SIZE ? '...' : ''}` }</p>
        </div>
        {#if $isTouchScreen}
            <div class="roundButton hide-description" on:click|stopPropagation={hide_description}>
                <p>-</p>    
            </div>
        {/if}
    </div>
